...
var rootPATH = bootPATH.replace(/public(.*)?/g, 'public/');
...
document.write('<script src="' + rootPATH + 'common/json2.js" type="text/javascript" ></sc' + 'ript>');
//加载CSS样式
...
document.write('<link href="' + rootPATH + 'admin/style/pc.css" rel="stylesheet" type="text/css" />');
